 ...
 * The DisplayManager uses the property "DISPLAYIMPL" to determine which type of
 * object will be used as the actual display. This is abstracted so that any
 * subsystem that implements the Display interface can act as the application's
 * display.
 */
public class DisplayManager implements Display {
    ...
    /**
     * This method sends the "Displayable" object passed in to the current
     * display object for addition to the list of elements that are drawn in the
     * display window.
     *
    ...
    /**
     * This method sends the "Displayable" object passed in to the current
     * display object for removal from the list of elements that are drawn in
     * the display window.
     *
     * @param d the "Displayable" object to be added to the list of elements
     * that are drawn in the display window.
    ...
    /**
     * This method sends the "ViewFrameListener" object passed in to the current
     * display object in order to set the display's ViewFrameListener The
     * ViewFrameListener is usually an object in your application.
     *
     * @param viewFrameListener the ViewFrame's ViewFrameListener object
    ...
    /**
     * This method instructs the display object to update itself. This is
     * usually done when you want to update the drawn elements after their
     * locations have been updated or when an element has been added or removed
     * from the list of elements drawn on the display.
     */
